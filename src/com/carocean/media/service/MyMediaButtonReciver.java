...
public class MyMediaButtonReciver extends BroadcastReceiver {
	private final static String TAG="MyMediaButtonReciver";
    @Override  
        ...
        if (Intent.ACTION_MEDIA_BUTTON.equals(intentAction)) {  
            ...
            if (keyAction == KeyEvent.ACTION_UP) {
    			...
    			case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
    				context.sendBroadcast(new Intent(MCU_ACTION_MEDIA_PLAY_PAUSE));
    				break;
