...
public class WifiUtils {
	...
	public void WifiOpen() {
		...
		if (localWifiManager.getWifiState() == WifiManager.WIFI_STATE_ENABLING
				|| localWifiManager.getWifiState() == WifiManager.WIFI_STATE_DISABLING) {
			return;
		}

		if (localWifiManager.getWifiState() == WifiManager.WIFI_STATE_DISABLED
				|| localWifiManager.getWifiState() == WifiManager.WIFI_STATE_UNKNOWN) {
	...
	public void WifiSwitch() {
		...
		if (localWifiManager.getWifiState() == WifiManager.WIFI_STATE_ENABLED) {
			localWifiManager.setWifiEnabled(false);
		} else if (localWifiManager.getWifiState() == WifiManager.WIFI_STATE_DISABLED
				|| localWifiManager.getWifiState() == WifiManager.WIFI_STATE_UNKNOWN) {
			if (localWifiManager.isWifiApEnabled())
				localWifiManager.setWifiApEnabled(null, false);
			localWifiManager.setWifiEnabled(true);
	...
	public DetailedState getDetailedState(Intent intent) {
		DetailedState mdState = ((NetworkInfo) intent.getParcelableExtra(WifiManager.EXTRA_NETWORK_INFO))
				.getDetailedState();
		return mdState;
	}
